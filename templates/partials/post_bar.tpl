		...
		<div class="d-flex flex-row p-2 text-bg-light border rounded w-100 align-items-center">
			<ul class="d-flex list-unstyled me-auto mb-0 gap-2 align-items-center flex-wrap">
				...
				<button component="topic/mark-unread" class="btn-ghost-sm d-flex gap-2 align-items-center">
					...
					<span class="d-none d-xl-inline fw-semibold">[[topic:mark-unread]]</span>
				</button>
				{{{ end }}}
				...
				<a class="btn-ghost-sm align-self-stretch" target="_blank" href="{rssFeedUrl}"><i class="fa fa-rss text-primary"></i></a>
				{{{ end }}}
