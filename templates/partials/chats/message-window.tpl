...
<div component="chat/messages" class="expanded-chat d-flex flex-column h-100" data-roomid="{roomId}">
	...
	<div component="chat/composer" class="d-flex flex-column flex-md-row gap-2 border-top pt-2 align-items-start align-items-md-end">
		<div class="w-100 flex-grow-1 position-relative input-group">
			<button component="chat/upload/button" class="btn btn-primary btn-sm align-self-stretch px-3 px-md-2" type="button"><i class="fa fa-fw fa-upload"></i></button>
			...
			<span component="chat/message/remaining" class="d-none text-xs text-muted position-absolute me-5 mb-1 end-0 bottom-0">{maximumChatMessageLength}</span>
